...
export default class PsycheEngine extends BaseEngine {
  constructor(gender: EGender, age: number) {
    super("Psühhika ja meeleolu", gender, age, [
      {
      ...
      {
        contentEst:
          "luulud, meelepetted, paranoia (näeb, kuuleb, tunneb asju mida ei ole olemas)",
        result: EResult.EmergencyRoom,
        contentEng: null,
        gender: EGender.any,
        minAge: null,
      ...
      {
        contentEst:
          "segasusseisund(ei saa ümbritsevast aru, ei tunne lähedasi inimesi ära)",
        result: EResult.EmergencyRoom,
        contentEng: null,
        gender: EGender.any,
        minAge: null,
      ...
      {
        contentEst:
          "pikemat aega kestnud masendus, meeleolulangus, huvipuudus, meeleheide",
        result: EResult.FamilyDoctor,
        contentEng: null,
        gender: EGender.any,
        minAge: null,

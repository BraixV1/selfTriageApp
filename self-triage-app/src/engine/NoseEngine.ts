...
export default class NoseEngine extends BaseEngine {
  constructor(gender: EGender, age: number) {
    super("Nina", gender, age, [
      {
        contentEst:
          "suur verejooks ülemistest hingamisteedest (kurgumandlite-, ninaverejooks mida ei suudeta peatada)",
      ...
      {
        contentEst:
          "ninaneelu haigus on seotud külmetuse ja/või viirushaigustega",

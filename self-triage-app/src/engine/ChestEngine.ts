...
export default class ChestEngine extends BaseEngine {
  constructor(gender: EGender, age: number) {
    super("Rindkere", gender, age, [
      ...
      {
        contentEst:
          "rindkere valu koos ebakorrapärase südamerütmiga (süda jätab lööke vahele)",
        result: EResult.EmergencyRoom,
        contentEng: null,
        gender: EGender.any,
        minAge: null,
      ...
      {
        contentEst:
          "valu rinnus kiirgusega kätte/kätesse, abaluude vahele, selga, lõuga, ülakõhtu",
        result: EResult.EmergencyRoom,
        contentEng: null,
        gender: EGender.any,
        minAge: null,
      ...
      {
        contentEst:
          "terav rindkerevalu hingamisel ja katsudes rindkere valu ei ole",
        result: EResult.EmergencyRoom,
        contentEng: null,
        gender: EGender.any,
        minAge: null,
      ...
      {
        contentEst:
          "torkiva iseloomuga valu rindkeres, mis lokaliseerub kindlasse punkti ning ei süvene koormusega",
        result: EResult.FamilyDoctor,
        contentEng: null,
        gender: EGender.any,
        minAge: null,
